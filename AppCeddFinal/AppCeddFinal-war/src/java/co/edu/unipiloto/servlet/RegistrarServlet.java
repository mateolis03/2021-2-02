...
public class RegistrarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer telefono = 0;
        try {
            telefono = Integer.valueOf(telefonoS);
        } catch (Exception e) {
        ...
        Cliente cliente;
        if (!(nombre.equals("") || doc == 0 || mail.equals("") || telefono == 0 || usuario.equals("") || direccion.equals("") || password.equals("") || passwordC.equals(""))) {
            ...
            if (password.equals(passwordC)) {
                cliente = new Cliente(doc, nombre, doc, mail, telefono, direccion, usuario, password);
