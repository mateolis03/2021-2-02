    ...
    <body>
        ...
        <div>
            <form action="./RecuperarServlet" method="POST">
                ...
                <input name="action" type="submit" value="Aceptar" class="login" style="margin-top: -15px"/>
                <p><jsp:getProperty name="servletRecuperar" property="mensaje" /></p>
                <input name="action" type="submit" value="Volver..." class="login" style="margin-top: 30px"/>
            </form>
        </div>
